...
const (
	...
	BookService_ShowBooks_FullMethodName  = "/proto.BookService/ShowBooks"
...
type BookServiceClient interface {
	...
	ShowBooks(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ShowBookResponse, error)
...
func (c *bookServiceClient) ShowBooks(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ShowBookResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShowBookResponse)
	err := c.cc.Invoke(ctx, BookService_ShowBooks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookServiceServer interface {
	...
	ShowBooks(context.Context, *EmptyRequest) (*ShowBookResponse, error)
...
func (UnimplementedBookServiceServer) ShowBooks(context.Context, *EmptyRequest) (*ShowBookResponse, error) {
...
func (UnimplementedBookServiceServer) DeleteBook(context.Context, *DeleteBookRequest) (*EmptyResponse, error) {
...
func _BookService_ShowBooks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmptyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookServiceServer).ShowBooks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookService_ShowBooks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).ShowBooks(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BookService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BookService_ShowBooks_Handler,
		},
		{
